...
interface SwitchProps
  ...
  thumbSize?: VariantProps<typeof switchThumbVariants>["size"]
}

const Switch = React.forwardRef<React.ElementRef<typeof SwitchPrimitives.Root>, SwitchProps>(
  ({ className, size, thumbSize, ...props }, ref) => (
    <SwitchPrimitives.Root className={cn(switchVariants({ size }), className)} {...props} ref={ref}>
      <SwitchPrimitives.Thumb className={cn(switchThumbVariants({ size: thumbSize || size }))} />
