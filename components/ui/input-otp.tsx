...
>(({ index, className, ...props }, ref) => (
  <Slot
    ...
    className={cn(
      ...
      "focus:z-10 focus:border-ring focus:ring-2 focus:ring-offset-background",
      className,
    )}
    {...props}
  >
...
const InputOTPMultiSlot = React.forwardRef<
  React.ElementRef<typeof Slot>,
  React.ComponentPropsWithoutRef<typeof Slot> & { index: number }
>(({ index, className, ...props }, ref) => (
  <Slot
...
InputOTPMultiSlot.displayName = "InputOTPMultiSlot"
...
export { InputOTP, InputOTPGroup, InputOTPSlot, InputOTPMultiSlot, InputOTPSeparator }
